...
static struct cmdtbl table[] = {
    {os9attr, "attr"},     {os9cmp, "cmp"},       {os9copy, "copy"},
    {os9dcheck, "dcheck"}, {os9del, "del"},       {os9deldir, "deldir"},
    {os9dir, "dir"},       {os9dsave, "dsave"},   {os9dump, "dump"},
    {os9format, "format"}, {os9free, "free"},     {os9fstat, "fstat"},
    {os9gen, "gen"},       {os9id, "id"},         {os9ident, "ident"},
    {os9list, "list"},     {os9makdir, "makdir"}, {os9modbust, "modbust"},
    {os9padrom, "padrom"}, {os9rename, "rename"}, {os9rdump, "rdump"},
    {NULL, NULL}};
