...
LC65E           pshs    A               ; SAVE SECTOR NUMBER DIFFERENCE
                ...
                bne     LC684           ; FALL THRU IF LAST SECTOR
...
LC6FC           lda     #$FF            ; THIS WILL CAUSE AN 'AO'
...
LCBE9           lda     FCBLST,X        ; CHECK THE PRE-SAVED FLAG
                ...
                lsrb
                lsrb
                lsrb    *               ; EIGHT DIRECTORY ENTRIES PER SECTOR
                addb    #$03            ; FIRST 3 SECTORS NOT DIRECTORY
...
; DISK BASIC MODIFIER FOR PMODE - ALLOWS FOR THE RAM THE DOS USES
                ...
                jsr     EVALEXPB        ; RETURN VALUE IN ACCB
...
LSET            clra    LSET            ; FLAG = 0
                ...
                blo     LD119           ; 'SE' ERROR IF < RANDOM FILE BUFFER
...
; *ONLY THE MSB OF THE ADDRESS
                ...
                puls    A,B,U           ; ACCB=NUMBER OF FILE BUFFERS
...
HDINIT          ldx     #SIGNON-1       ; Point to sign-on
                ...
                jsr     >LD6C2          ; write regA bytes of regB data to regX
