...
void	relio()
	...
	add_pc_sym(pcl);
	if (dat & 0x8000)
		sprintf(str, "z%06x(pc,a%1d", pcl & 0xffffff, (dat & 0x7000) >> 12);
	else
		sprintf(str, "z%06x(pc,d%1d", pcl & 0xffffff, (dat & 0x7000) >> 12);
