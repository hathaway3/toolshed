...
== HOW TO BUILD firmware (hdbdos, dwdos, cocoroms, superdos) ==
...
NOTE: The hdbdos build depends on equates generated by cocoroms, so build
cocoroms first if building hdbdos separately.
