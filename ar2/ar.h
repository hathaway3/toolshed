 ...
 * Files need to be opened in binary mode under Windows too, failing which
 * ftell() and fseek() do not work as expected.  from Christian Lesage
 *
 ...
 * Merged in pwz unixification (Sunos).
 *
...
/* Files need to be opened in binary mode under Windows too, failing which
 * ftell() and fseek() do not work as expected.  5/26/10 Christian Lesage */
